...
function init() {
    ...
    scene.background = new THREE.Color( 0x0a1a2b );
    ...
    for ( let x = 0; x < amount; x ++ ) {
        ...
        for ( let z = 0; z < amount; z ++ ) {
            ...
            // Перший базовий колір (не обов’язково, але лишаю)
...
function animate() {
    ...
    for ( let i = 0; i < mesh.count; i ++ ) {
        ...
        if ( animation.t > 0 ) {
            ...
            let f = dummy.position.length() / maxDistance;
